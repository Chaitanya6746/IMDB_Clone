...
<html lang="en">
  ...
  <body style="background-color: black;">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        ...
        if (isset($_SESSION['email'])){
          ...
          <input class="form-control me-2 w-100" type="search" placeholder="Search" aria-label="Search" id="movie">
          <button class="btn btn-outline-light me-3" type="submit" id="search">Search</button>      
        </form>';
        }
        ?>
        ...
        <ul class="navbar-nav ">
          ...
          if(!isset($_SESSION['email'])){
            ...
            echo '<li class="nav-item me-4">
            <a class="nav-link active" aria-current="page" href="./logout.php"><b>Sign out</b></a>
          </li>';
    ...
    <div class="container">
        <div class="row my-5">
            ...
            <p class="h3 text-warning">Up next</p>
                <div class="card mb-3 bg-dark" style="max-width: 540px;margin-right:2rem">
                <div class="row g-0">
                    <div class="col-md-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12" style="display: flex;justify-content:center;width:auto;flex-wrap:wrap;margin: left 20px;"  id="output">
	...
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': '16df81cffcmshd79bb8fe10169c0p17607bjsn3c255d71d22d',
...
fetch(`https://imdb8.p.rapidapi.com/auto-complete?q=${moviename}`, options)
    ...
    card=card + `<div class="card mb-3" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
